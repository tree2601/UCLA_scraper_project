...
def search():
    ...
    for single_info in temp_result:
        url_title_description_dic={}
        url_title_description_dic['url'] = single_info['url']
        url_title_description_dic['title'] = single_info['title']
        url_title_description_dic['description'] = single_info['description']

        url_title_description_list.append(url_title_description_dic)

    url_title_description_json_array=json.dumps(url_title_description_list)
    return url_title_description_json_array
